...
```{r}
s_vector      <- data.frame(n_mass=1, ts=0, x=0, y=0, z=0, dot.x=10, dot.y=20, dot.z=30)
s_vector[2, ] <- data.frame(n_mass=2, ts=0, x=3000, y=0, z=0, dot.x=0, dot.y=40, dot.z=0)
```
...
for(i in 1:53) { new_s_vector <- get_next_s_vector(new_s_vector, 10e-10) }
```
