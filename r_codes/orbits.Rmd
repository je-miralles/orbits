...
We often try to find one that is not accelerating. In orbital mechanics the frame is usually chosen with respect to the *fixed stars*. In these so called *inertial* frames Newton's [laws of motion](https://en.wikipedia.org/wiki/Newton's_laws_of_motion) apply:
