...
get_derived_initial_values <- function(pos_0, pos_1) {
  ...
  ddotR0_0 <- m_1 * G * (pos_1 - pos_0) / (R0^3)
  ddotR0_1 <- m_0 * G * (pos_0 - pos_1) / (R0^3)
  init_vals <- data.frame(R=R0, ddot_0=ddotR0_0, ddot_1=ddotR0_1)
  init_vals
}
...
get_next_s_vector <- function(s_vector, timestep=1) {
  ...
  # step forward
  new_pos_0 <- step(pos_0, vel_0, timestep)
  new_pos_1 <- step(pos_1, vel_1, timestep)
  new_vel_0 <- step(vel_0, init_vals[2:4], timestep)
  new_vel_1 <- step(vel_1, init_vals[5:7], timestep)
