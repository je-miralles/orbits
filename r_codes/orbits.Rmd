...
We often try to find a frame that is not accelerating. This is hard! Everything turns out to be wagging a little, even what we can't see. But supposing we choose an *inertial frame* like this, we would find that Newton's [laws of motion](https://en.wikipedia.org/wiki/Newton's_laws_of_motion) apply:
