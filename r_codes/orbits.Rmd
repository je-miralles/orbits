...
We can see the mutual attraction pull $m_1$ off of the origin as the two bodies approach each other, eventually getting within $80 \text{km}$ where the maximum gravitational acceleration slingshots the two back away from each other at high speed.
