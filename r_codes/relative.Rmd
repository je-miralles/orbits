...
Lets take a moment to compare with our previous results. Where we had a state vector of 12 quantities before, $S = [{\bf r}_0, {\bf r}_1, {\bf \dot{r}}_0, {\bf \dot{r}}_1]$,

$$
\begin{align}
\ddot{\bf r}_0 &= -G m_1 \frac{\ddot{\bf r}_0 - \ddot{\bf r}_1}{r^3} \\
\ddot{\bf r}_1 &= -G m_0 \frac{\ddot{\bf r}_1 - \ddot{\bf r}_0}{r^3} \\
\end{align}
$$

we now have a single equation, with only six, $S = [{\bf r}, {\bf \dot{r}}]$.
