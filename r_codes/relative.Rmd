...
ellipse_coords(E = E_earth, l = l_earth, m = m_earth, G = G, M = m_sun, 0, 360)
```
...
ellipse_coords(E = E_pluto, l = l_pluto, m = m_pluto, G = G, M = m_sun, 0, 360)
```
